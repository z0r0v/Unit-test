...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/modules/users.service.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(UsersService, [{
    key: "get",
    value: function get() {
      return _axios.default.get('https://m-fd2-54-19.herokuapp.com/users').then(function (response) {
    ...
    value: function getDescending() {
      return _axios.default.get('https://m-fd2-54-19.herokuapp.com/users?_sort=name&_order=desc').then(function (response) {
        return response.data;
      });
    }
  }]);
...
},{"axios":"node_modules/axios/index.js"}],"src/modules/users.js":[function(require,module,exports) {
"use strict";
...
function () {
  function Users() {
    ...
    _userService = new _users.UsersService();
  }

  _createClass(Users, [{
    key: "init",
    value: function init() {
      _userService.get().then(function (data) {
...
exports.Users = Users;
},{"./users.service":"src/modules/users.service.js"}],"src/modules/main.js":[function(require,module,exports) {
"use strict";

var _users = require("./users");

new _users.Users().init();
},{"./users":"src/modules/users.js"}],"src/index.js":[function(require,module,exports) {
"use strict";

require("./modules/main");
},{"./modules/main":"src/modules/main.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
